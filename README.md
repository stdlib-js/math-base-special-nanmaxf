...
<!-- <div class="equation" align="center" data-raw-text="\operatorname{nanmax}(x, y) = \begin{cases} y &amp; \textrm{if}\ x = \text{NaN} \\ x &amp; \textrm{if}\ y = \text{NaN} \\ \max(x, y) &amp; \textrm{otherwise} \end{cases}" data-equation="eq:nanmax_function">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@85f48534ef6908bbcd982d48f1c5fbea3fb7aafd/lib/node_modules/@stdlib/math/base/special/nanmaxf/docs/img/equation_nanmax_function.svg" alt="Maximum value ignoring NaN">
    <br>
</div> -->
